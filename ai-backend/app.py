...
def run_rag_pipeline(
    ...
    if budget["max"] is not None:
        budget_reminder = f"\n\nBUDGET INFO: The user has a maximum budget of {budget['max']} $. Only recommend products priced at or below {budget['max']} $."
    elif budget["min"] is not None:
        budget_reminder = f"\n\nBUDGET INFO: The user wants products above {budget['min']} $. Only recommend products priced above {budget['min']} $."
